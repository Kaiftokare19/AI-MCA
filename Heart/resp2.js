...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const initialMessage = `<div class="chat-message bot">Hello! I am Dr.Cardiologist 🤖. How can I assist you with your Heart disease-related queries today?</div>`;
...
async function sendMessage() {
    ...
    try {
        const response = await fetch("###Upload You're API KEY###", {
            method: "POST",
            headers: {
